...
MainFrame::MainFrame(const wxString& title) : wxFrame(nullptr, wxID_ANY, title) {
    ...
    wxStaticText* staticText = new wxStaticText(panel, wxID_ANY, "StaticText - NOT editable", wxPoint(400, -1), wxSize(400, -1), wxALIGN_CENTRE_HORIZONTAL);
    ...
    wxSpinCtrl* spinCtrl = new wxSpinCtrl(panel, wxID_ANY, "", wxPoint(550, 375), wxSize(200, 50), wxSP_WRAP);
...
// Se puede observar que se crean controles de tipo wxButton, wxCheckBox, wxStaticText, wxTextCtrl, wxSlider, wxGauge, wxChoice, wxSpinCtrl, wxListBox y wxRadioBox.